...
# This is a modified version of the official sandbox script, with tweaks for
# usage with Docker containers. 
# Original script: https://github.com/tezos/tezos/blob/master/src/bin_node/tezos-sandboxed-node.sh#L168
